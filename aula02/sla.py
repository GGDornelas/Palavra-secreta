...
# Herança = usa uma outra classe para pegar informações como base e não precisar repetir oque está contido nela, boa prática
# Polimorfismo = permite que métodos com o mesmo nome, em classes diferentes possam ser chamados da mesma forma, independentemente da classe do objeto.
